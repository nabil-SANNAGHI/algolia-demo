...
const searchBarContainer = document.querySelector("#app");
...
const searchClient = algoliasearch(
  "OERO1TVX42",
  "674dc4f03e62991c44324c93241f3078",
);
				...
				<div>
				  <p class="primary-text">
					...
					<p class="secondary-text">
					  ${components.Highlight({ hit, attribute: "overview" })}
					</p>
					<p class="tertiary-text">
					  ${components.Highlight({ hit, attribute: "releaseDate" })}
					</p>
				</div>
      `,
    },
